...
def parse_args():
    ...
    parser.add_argument("--ref_path", type=str,
                        default="/mnt/gestalt/home/rakec/data/diff-mst/MedleyDB_V2/V2/TleilaxEnsemble_Late/TleilaxEnsemble_Late_MIX.wav",
                        help='Path to reference audio for mixing')
    ...
    # Other parameters
    parser.add_argument("--output_dir", type=str, default="/mnt/gestalt/home/rakec/output/diff-mst/eval_audio",
                        help='Directory to save generated audio examples')
    parser.add_argument("--exp_name", type=str, default="TleilaxEnsemble_Late", 
...
def main():
    ...
    # Find all tracks
    track_filepaths = list(pathlib.Path(example["tracks"]).glob("*.wav"))
