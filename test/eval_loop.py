...
def parse_args():
    ...
    parser.add_argument("--control_info", type=str, nargs='+', 
                        default=["/kaggle/input/medley-db-v2/V2/Allegria_MendelssohnMovement1/Allegria_MendelssohnMovement1_MIX.wav", (-1, 1.0, "The sound is extremely bright"), (1, 1, "The sound is extremely bright" )],
