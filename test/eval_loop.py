...
def parse_args():
    ...
    parser.add_argument("--control_info", type=str, nargs='+', 
                        default=["/kaggle/input/medley-db-v2/V2/TleilaxEnsemble_Late/TleilaxEnsemble_Late_MIX.wav", (-1, 1.0, "The sound is extremely bright"), (2, 1, "The sound is extremely bright" )],
